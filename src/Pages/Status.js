...
const Status = () => {
  ...
  useEffect(() => {
    console.log(studentRef.current.value);
  });
          ...
          <div className="pt-16 px-20 w-full mb-10">
            <div className="mt-4 w-full">
              ...
              <div className="w-full bg-white rounded-lg shadow px-4 py-2">
                <span>
                  <h1 className="uppercase font-semibold">Your information</h1>
                </span>
                <div className="flex w-full my-5">
                  <div className="grid grid-cols-4 w-full gap-y-3 ">
                    ...
                    <Info title="Form four Number" value={form_four_number} />
                ...
                <div className="mt-5 pr-16 w-full flex flex-col gap-x-5">
                  <div className="p-3 bg-orange-100 rounded-lg text-sm">
                    Index Number Format! All applicant who have attended NECTA
                    (Tanzania) Form Four examination, their Index Number should
                    be put on this Format (SXXXX/XXXX or PXXXX/XXXX or
                    BXXXX/XXXX) and all equivalent applicant their index number
                    should be put on this Format (EQYYYYXXXXXX)
                  </div>
                  <div className="flex items-center w-full  justify-between">
                    ...
                    <div className="my-2 flex flex-col">
                      <label className="">Enter yearof olevo completion</label>
                      <input
