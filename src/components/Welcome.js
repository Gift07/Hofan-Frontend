...
const Welcome = () => {
  return (
    <div className='w-screen bg-blue-100'>
        ...
        <div className='mt-8'>
          <h1 className='text-[#002080] text-2xl uppercase font-semibold'>Welcome !</h1>
        </div>
        <div className='my-3'>
        ...
        <div className='mt-8 pb-10  flex  items-center justify-center'>
            <div className='grid grid-cols-2 w-full items-center justify-center gap-x-4'>
                <div className='w-full h-full'>
                    <img src={Kenny} alt="kenny" className='w-full h-full object-cover rounded-lg'/>
                </div>
                  ...
                  <div className='h-10 w-full bg-blue-600 rounded-t-lg flex items-center font-semibold'>
                    ...
                    <div className='px-4 py-4'>
                      <p className='text-sm text-gray-800'>
                         Elit incididunt proident ipsum tempor id dolor sunt. Voluptate et do do nisi ut nulla adipisicing proident nostrud duis amet adipisicing i
                         ncididunt cupidatat. Esse labore duis dolore aute eu.
                      </p>
                    </div>
                    <div className='px-4'>
                      <p className='text-sm text-gray-700'>
                        Nulla id anim eu ut quis amet occaecat minim commodo aliquip eiusmod. Cillum incididunt veniam voluptate 
                        dolor exercitation enim nisi sint. Mollit proident laboris ex aute labore laboris nulla labore pariatur Lorem ullamco
                        cupidatat non et. Enim cupidatat ea tempor et sit sint sunt esse cillum anim. Voluptate eu sint eu est esse pariatur labore duis.
                      </p>
                    </div>
